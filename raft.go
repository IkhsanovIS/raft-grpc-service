...
func (rc *raftNode) publishEntries(ents []raftpb.Entry) (<-chan struct{}, bool) {
	...
	for i := range ents {
		...
		case raftpb.EntryConfChange:
			log.Println("This point publish new apply conf change entry")
...
func (rc *raftNode) startRaft() {
	...
	if oldwal || rc.join {
		...
		log.Println("before start node with peers")
	...
	log.Println("state before start transport")
	rc.transport.Start()
	log.Println("Started transport")
...
func (rc *raftNode) serveChannels() {
	...
	for {
		...
		case rd := <-rc.node.Ready():
			log.Println("get new entries wal")
